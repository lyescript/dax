...
compile = function (form) {
  ...
  if (nil63(_form)) {
    ...
    if (special_form63(_form)) {
      ...
      var _e47;
      if (atom63(_form)) {
        _e47 = compile_atom(_form);
      } else {
        var _e48;
        if (infix63(hd(_form))) {
          _e48 = compile_infix(_form);
        } else {
          _e48 = compile_call(_form);
        }
        _e47 = _e48;
      }
      var _form1 = _e47;
...
var fix_require = function () {
  ...
  var _ok = __id27[0];
  if (! _ok) {
    var _dir = require("path").dirname(process.execPath);
    module.filename = require("path").resolve(_dir, "repl");
  }
...
setenv("%local", {_stash: true, special: function (name, value) {
  ...
  return(_ind11 + _keyword1 + _id29 + _rh2);
}, stmt: true});
...
setenv("%literal", {_stash: true, special: function () {
  ...
  var __x172 = _args111;
  var __i26 = 0;
  while (__i26 < _35(__x172)) {
    var _x173 = __x172[__i26];
    var _x1211 = compile(_x173);
    _s111 = _s111 + _x1211;
    __i26 = __i26 + 1;
  }
  return(_s111);
